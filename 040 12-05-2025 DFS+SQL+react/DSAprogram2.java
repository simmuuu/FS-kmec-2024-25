...
public class DSAprogram2 {
    private static int sol(int[] inp, int money) {
        // PriorityQueue<Integer> pq = new PriorityQueue<>();
        // for (int i: inp) pq.add(i);
        
        // while(!pq.isEmpty() && money - pq.peek() >= 0) money -= pq.poll();
        // return inp.length - pq.size();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol(inp, money));
    }
}